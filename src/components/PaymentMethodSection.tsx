    ...
    <div className="w-full max-w-2xl mx-auto p-6">
      ...
      <div className="flex items-center gap-4 border-b border-gray-200 pb-6 mb-6">
        <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
          <MessageText1 size={24} className="text-sub-text" />
        </div>
        <div>
          <h2 className="text-2xl font-bold text-black">UPI ID</h2>
          <p className="text-sub-text">PhonePe, Gpay, Paytm, BHIM & more</p>
        </div>
      </div>
